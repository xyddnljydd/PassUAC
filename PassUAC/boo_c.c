...
static const RPC_CLIENT_INTERFACE boo___RpcClientInterface =
    {
...
RPC_IF_HANDLE boo_v1_0_c_ifspec = (RPC_IF_HANDLE)& boo___RpcClientInterface;

extern const MIDL_STUB_DESC boo_StubDesc;

static RPC_BINDING_HANDLE boo__MIDL_AutoBindHandle;
    ...
    /* [out] */ long *ElevationType)
{
    ...
    NdrAsyncClientCall(
                      ( PMIDL_STUB_DESC  )&boo_StubDesc,
                      (PFORMAT_STRING) &boo__MIDL_ProcFormatString.Format[0],
...
static const MIDL_STUB_DESC boo_StubDesc = 
    {
    (void *)& boo___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &boo__MIDL_AutoBindHandle,
    0,
    0,
    0,
    0,
